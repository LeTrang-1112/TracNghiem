...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Bài Thi Bậc TRUNG HỌC CƠ SỞ</h1>
    </div>
</header>
<style>
  #left_sidebar{
...
?>
    ...
    <div id="main_content">
        ...
        <div id="content">
          <h3>ĐỀ TRẮC NGHIỆM TRUNG HỌC CƠ SỞ</h3>
          <?php
              $i=1;
              foreach($result as $ds){
                if($ds['capdo']=='Trung Học Cơ Sở' && $ds['trangthai']=='ON'){
              ?>
