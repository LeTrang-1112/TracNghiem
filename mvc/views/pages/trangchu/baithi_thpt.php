...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Bài Thi Bậc TRUNG HỌC PHỔ THÔNG</h1>
    </div>
</header>
<style>
  #left_sidebar{
...
<?php
  ...
  ?>
    ...
    <div id="main_content">
        ...
        <div id="content">
          <h3>ĐỀ THI TRUNG HỌC PHỔ THÔNG</h3>
          
          <form action="trangchu/lamBaiThi?id=<?php echo $ds['id'];?>" method="GET">
          <?php
              $i=1;
              foreach($result as $ds){
                if($ds['capdo']=='Trung Học Phổ Thông' && $ds['trangthai']=='ON'){
